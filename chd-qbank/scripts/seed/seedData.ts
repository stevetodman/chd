...
export const QUESTIONS: QuestionSeed[] = [
  {
    ...
    explanation_brief_md:
      'Ductal-dependent systemic circulation requires prostaglandin to reopen the ductus.',
    explanation_deep_md:
  ...
  },
  {
    ...
    stem_md:
      'Infant with failure to thrive has a harsh holosystolic murmur at the lower left sternal border.',
    lead_in: 'Which lesion best explains these findings?',
    explanation_brief_md:
      'A ventricular septal defect produces a holosystolic murmur at the left lower sternal border.',
    explanation_deep_md:
  ...
  },
  {
    ...
    choices: [
      ...
      {
        label: 'D',
        text_md: 'Aggressively lower pulmonary vascular resistance',
        is_correct: false,
      },
    ],
  },
