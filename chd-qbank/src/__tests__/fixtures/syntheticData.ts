...
export const syntheticPracticeQuestions: QuestionQueryRow[] = [
  {
    ...
    explanation_brief_md:
      'Severe pulmonary regurgitation after TOF repair is treated with pulmonary valve replacement.',
    explanation_deep_md:
    ...
    context_panels: [
      {
        ...
        formulas: [{ name: 'CaO2', expression: '(1.34 x Hb x SaO2) + (0.003 x PaO2)' }],
        body_md:
          'Mixing at the atrial level is critical while systemic and pulmonary circulations run in parallel.',
      },
    ],
    choices: [
      {
  ...
  },
  {
    ...
    explanation_brief_md:
      'Irreversible pulmonary vascular remodeling leads to Eisenmenger physiology if repair is delayed.',
    explanation_deep_md:
...
export const syntheticMurmurItems = [
  {
    ...
    rationale_md:
      'The murmur radiates to the right lower sternal border and increases with inspiration, consistent with tricuspid regurgitation.',
