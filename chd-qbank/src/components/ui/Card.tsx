...
export const CardHeader = forwardRef<HTMLDivElement, CardHeaderProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={classNames('border-b border-surface-muted/70 px-6 py-4', className)}
      {...props}
    />
  ),
);
...
export const CardTitle = forwardRef<HTMLHeadingElement, CardTitleProps>(
  ({ className, ...props }, ref) => (
    <h2
      ref={ref}
      className={classNames(
        'text-lg font-semibold tracking-tight text-surface-inverted',
        className,
      )}
      {...props}
    />
...
export const CardFooter = forwardRef<HTMLDivElement, CardFooterProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={classNames('border-t border-surface-muted/70 px-6 py-4', className)}
      {...props}
    />
  ),
);
